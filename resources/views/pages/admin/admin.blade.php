    ...
    <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark position-sticky top-0 d-flex flex-column "
                ...
                <div class="sb-sidenav-footer position-sticky bottom-0 ">
                    <div class="small text-wrap" style="max-width:225px;"><i class="bi bi-person"></i>
                        Masuk Sebagai : &nbsp;{{ auth()->user()->name }}</div>
                </div>
            </nav>
        </div>
