<div data-section="data-khusus" class="row gx-0 d-none ">
    <div class="form-group mb-3 col-8 ">
        ...
        <input type="text"
            ...
            id="asal_kelompok_sambung" name="asal_kelompok_sambung" required>
    </div>
    <div class="form-group mb-3 col-8 ">
        <label for="asal_desa_sambung" class="required">Asal desa sambung:</label>
        <input type="text"
            class="form-control ps-1 bg-transparent border-0 border-bottom border-2 rounded-0 focus-ring-none "
            id="asal_desa_sambung" name="asal_desa_sambung" required>
    </div>
    <div class="form-group mb-3 col-8 ">
        <label for="asal_daerah_sambung" class="required">Asal daerah sambung:</label>
        <input type="text"
            class="form-control ps-1 bg-transparent border-0 border-bottom border-2 rounded-0 focus-ring-none "
            id="asal_daerah_sambung" name="asal_daerah_sambung" required>
    </div>
    <div class="form-group mb-3 col-4 me-3 ">
        ...
        <div class="input-group">
            <input type="number"
                class="form-control ps-1 bg-transparent border-0 border-bottom border-2 rounded-0 focus-ring-none "
                id="jumlah_hafalan" name="jumlah_hafalan" required>
    ...
    <div class="form-group mb-3">
        ...
        <div class="input-group d-flex column-gap-4 align-items-center">
            <div class="d-flex gap-1 align-items-center justify-content-center ">
                <input type="radio" required name="status_mubaligh" class="form-switch " id="belum"
                    value="belum">
                <label for="belum">Belum</label>
            </div>
            <div class="d-flex gap-1 align-items-center justify-content-center ">
                <input type="radio" required name="status_mubaligh" class="form-switch " id="sudah"
                    value='sudah'>
