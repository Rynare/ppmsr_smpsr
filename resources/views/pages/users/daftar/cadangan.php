...
<body class="" style="background-color: var(---bg-body)">
    <style>
        :root {
            ---bg-body: #f0ebf8;
        }
    ...
    <main class="container-fluid">
        <div id="content" class="row row-cols-1 mb-5 ">
            <div class="col-lg-6 mx-auto ">
                <div class="row row-cols-sm-1 mx-auto ">
                    <div class="col col-auto ms-sm-auto main-form-container" style="">
                        ...
                        <div class="mt-1 mb-3 py-1 position-sticky top-0 z-3 border-2 px-2 rounded " style="background-color: white;">
                            <div class="progress shadow" id="progress-bar" role="progressbar" aria-label="Success progress" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style="height: 5px">
                                <div class="progress-bar bg-success" style=""></div>
                            </div>
                        </div>
                        <form class="px-1" action="{{ route('santri-daftar.store') }}" method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column; row-gap: 20px">
                            @csrf

                            <!-- Nama -->
                            <!-- <div class="form-group">
                                <label for="nama" class="required">Nama:</label>
                                <input type="text" class="form-control" id="nama" name="nama" required onkeydown="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)" onchange="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)" onkeyup="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)" autofocus>
                                <small id="nama-help" class="text-muted">Masukkan nama sesuai dengan ktp</small>
                            </div> -->

                            <!-- <div class="form-group ">
                                <p class="required d-block ">Jenis Kelamin:</p>
                                <div class="input-group d-flex column-gap-3 align-items-center">
                                    <div>
                                        <input type="radio" name="jenis-kelamin" class="form-switch " id="lk">
                                        <label for="lk">Laki-laki</label>
                                    </div>
                                    <div>
                                        <input type="radio" name="jenis-kelamin" class="form-switch " id="pr">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="tanggal_masuk_pondok" name="tanggal_masuk_pondok" required onchange="validateDateInput(this)">
                            </div> -->

                            <!-- Cita-cita -->
                            <!-- <div class="form-group">
                                <label for="cita_cita" class="required">Cita-cita:</label>
                                <input type="text" class="form-control" id="cita_cita" name="cita_cita" required onkeydown="validateInput(this, /^[a-zA-Z.,\s]+$/, 0, 255)" onkeyup="validateInput(this, /^[a-zA-Z.,\s]+$/, 0, 255)" onchange="validateInput(this, /^[a-zA-Z.,\s]+$/, 0, 255)">
                            </div> -->
                            ...
                            <!-- <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_saudara" name="jumlah_saudara" required aria-describedby="jumlah_saudara-help" max="20" onkeydown="jumlahSaudaraCheck(this)" onkeyup="jumlahSaudaraCheck(this)" onchange="jumlahSaudaraCheck(this)" ry-target="#anak_ke">
                            ...
                            <!-- <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="anak_ke" name="anak_ke" required max="20" onkeyup="anak_keCheck(this)" onkeydown="anak_keCheck(this)" onchange="anak_keCheck(this)" disabled ry-from="#jumlah_saudara">
                                </div>
                            </div> -->
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="no_hp_santri" name="no_hp_santri" required aria-describedby="no.hp-help" placeholder="8########" onkeydown="phoneNumberCheck(this)" onkeyup="phoneNumberCheck(this)" onchange="phoneNumberCheck(this)">
                                </div>
                            ...
                            <!-- <div class="form-group">
                                <label for="orang_pembayar_sekolah" class="required">Orang yang membiayai sekolah
                                    santri:</label>
                                <input type="text" class="form-control" id="orang_pembayar_sekolah" name="orang_pembayar_sekolah" onkeydown="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)" onkeyup="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)" onchange="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)">
                            </div> -->

                            <!-- Nama Ayah -->
                            <!-- <div class="form-group">
                                <label for="ayah_kandung" class="required">Ayah Kandung:</label>
                                <input type="text" class="form-control" id="ayah_kandung" name="ayah_kandung" required onkeydown="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)" onkeyup="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)" onchange="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)">
                            </div> -->
                            ...
                            <div class="row row-gap-4">
                                ...
                                <!-- <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="pekerjaan_ayah" name="pekerjaan_ayah" required onkeydown="validateInput(this, /^[a-zA-Z.,\s]+$/, 0, 255)" onkeyup="validateInput(this, /^[a-zA-Z.,\s]+$/, 0, 255)" onchange="validateInput(this, /^[a-zA-Z.,\s]+$/, 0, 255)">
                                </div> -->
                                ...
                                <!-- <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="penghasilan_ayah" onkeydown="currencyCheck(this)" onkeyup="currencyCheck(this)" onchange="currencyCheck(this)" onkeydown="validateInput(this,/^[0-9]+$/,7,14)" onkeyup="validateInput(this,/^[0-9]+$/,7,14)" onchange="validateInput(this,/^[0-9]+$/,7,14)">
                                        <input type="number" class="form-control" name="penghasilan_ayah" required hidden max="99999999999">
                                    </div>
                                </div> -->
                            </div>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">+62</span>
                                    <input type="number" class="form-control" id="no_hp_ayah" name="no_hp_ayah" required aria-describedby="no.hp_ayah-help" placeholder="8########" onkeydown="phoneNumberCheck(this)" onkeyup="phoneNumberCheck(this)" onchange="phoneNumberCheck(this)">
                                </div>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ibu_kandung" name="ibu_kandung" required onkeydown="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)" onkeyup="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)" onchange="validateInput(this, /^[a-zA-Z.\s\`]+$/, 0, 255)">
                            </div> -->
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">+62</span>
                                    <input type="number" class="form-control" id="no_hp_ibu" name="no_hp_ibu" required aria-describedby="no.hp_ibu-help" placeholder="8########" onkeydown="phoneNumberCheck(this)" onkeyup="phoneNumberCheck(this)" onchange="phoneNumberCheck(this)">
                                </div>
                                <small id="no.hp_ibu-help" class="text-muted">Langsung tulis tanpa 62/+62 ataupun 0
                                    didepan</small>
                            </div>-->
                            ...
                            <!-- <div class="form-group">
                                ...
                                <textarea class="form-control" id="alamat_orangtua" name="alamat_orangtua" rows="3" required placeholder="Masukkan alamat sesuai KTP" onkeydown="validateInput(this, /^[a-zA-Z0-9,.\(\)\/\-\`\s]+$/, 0, 2000)" onkeyup="validateInput(this, /^[a-zA-Z0-9,.\(\)\/\-\`\s]+$/, 0, 2000)" onchange="validateInput(this, /^[a-zA-Z0-9,.\(\)\/\-\`\s]+$/, 0, 2000)"></textarea>
                            </div>  -->
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="tanggal_lahir_santri" name="tanggal_lahir_santri" required onchange="validateDateInput(this)">
                            </div> -->

                            <!-- Tempat Lahir Santri -->
                            <!-- <div class="form-group">
                                <label for="tempat_lahir_santri" class="required">Tempat Lahir Santri:</label>
                                <input type="text" class="form-control" id="tempat_lahir_santri" name="tempat_lahir_santri" required placeholder="Kota lahir" onkeydown="validateInput(this, /^[a-zA-Z\s]+$/, 0, 255)" onkeyup="validateInput(this, /^[a-zA-Z\s]+$/, 0, 255)" onchange="validateInput(this, /^[a-zA-Z\s]+$/, 0, 255)">
                            </div> -->

                            <!-- Kartu Keluarga -->


                            <button type="submit" class="btn btn-primary col-md-2 ms-sm-auto " disabled>Submit</button>
                        </form>
                    </div>
                </div>
            </div>
