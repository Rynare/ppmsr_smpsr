<div data-section="data-orangtua" class="row gx-0 d-none ">
    ...
    <div class="form-group col-md-6 col-4 mb-3">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control focus-ring-none" data-input='currency' id="penghasilan_ayah"
    ...
    <div class="form-group col-md-6 col-4 mb-3">
        ...
        <div class="input-group">
            <span class="input-group-text">Rp.</span>
            <input type="text" class="form-control focus-ring-none" data-input='currency' id="penghasilan_ibu"
                data-input-real-target="[name=penghasilan_ibu]">
