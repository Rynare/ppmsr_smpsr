...
@section('custom')
    <div id="content" class="mx-auto">
            ...
            <ul class="nav nav-underline">
                <li class="nav-item">
                    <a class="nav-link text-danger active" aria-current="page" data-section-target="datadiri"
                        href="#datadiri">Data Diri</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-danger" data-section-target="data-orangtua" href="#data-orangtua">Data ortu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-danger" data-section-target="data-khusus" href="#data-khusus">Data khusus</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-danger " aria-disabled="true" data-section-target="data-wali"
                        href="#data-wali">Data wali</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-danger " aria-disabled="true" data-section-target="data-imam"
                        href="#data-imam">Data imam</a>
                </li>
                <li class="nav-item">
        ...
        <main class="row row-cols-lg-1 gx-0 px-4 my-3 ">
            <form action="{{ route('santri-daftar.store') }}" method="post" class="row gx-0">
